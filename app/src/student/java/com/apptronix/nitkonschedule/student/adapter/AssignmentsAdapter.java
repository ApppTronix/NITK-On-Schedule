...
public class AssignmentsAdapter extends CursorAdapter{
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        if(cursor.getCount()>0){
            ...
            holder.assignmentWeightage.setProgress(Integer.parseInt(cursor.getString(cursor.getColumnIndex(DBContract.AssignmentsEntry.COLUMN_WEIGHTAGE))));
        } else {
    ...
    private class AssignmentViewHolder {
        ...
        public AssignmentViewHolder(View itemView) {
            ...
            assignmentSubmissionDate= itemView.findViewById(R.id.assignmentSubmission);
            assignmentWeightage= itemView.findViewById(R.id.assignmentWeightage);
